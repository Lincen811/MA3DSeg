...
parser.add_argument('--root', type=str, default='LBT2024',  help='Root folder of all your images and labels')
parser.add_argument('--output', type=str, default='LBT2024_output',  help='Output folder for both tensorboard and the best model')
parser.add_argument('--dataset', type=str, default='lbt',  help='Datasets: {feta, flare, amos}, Fyi: You can add your dataset here')
...
parser.add_argument('--trained_weights', default='LBT2024/output/best_metric_model.pth',  help='Path of pretrained/fine-tuned weights')
